...
RF.BUILD={
  version:'10.62.0',
  title:'Dungeon Gauntlets',
  built:'17 Sep 2026 • 20:46 BST',
  buildId:'20260917-2046-bst'
};
RF.V1062=RF.V1062||{};

/* Realmforge V10.62 — Dungeon Gauntlets
   - Replaces the old one-room delve flow with persistent 8-wave dungeon runs plus a final boss.
   - Gives every existing dungeon location its own new boss and tier-appropriate equipment rewards.
   - Adds a dedicated World > Dungeon card, wave/boss interstitials, live wave display and a full-run summary.
   - Dungeon rewards are overflow-safe under V10.56 and existing campaigns/loadouts migrate in place.
*/
...
// Preserve all existing save/loadout state. V10.62 only adds dungeon records/active-run data.
...
if(RF.V95){RF.V95.SCHEMA='10.62.0';const om=RF.V95.migrate.bind(RF.V95);RF.V95.migrate=s=>V.migrate(om(s))}
