...
/* Realmforge V12.5.0 — canonical system/UI ownership verification. */
(() => {
  'use strict';
  const RF=window.RF;
...
/* Realmforge V12.5.0 production finalizer. */
(() => {
  'use strict';
  const RF=window.RF;
  RF.VERSION='12.5.0';
  RF.BUILD={version:'12.5.0',title:'Hardcore & Character Records',built:'22 Sep 2026 • V12',buildId:'20260922-v1250-hardcore'};
  RF.PRODUCTION_FOUNDATION=RF.PRODUCTION_FOUNDATION||{};
