...
/* Realmforge V12.7.0 — canonical system/UI ownership verification. */
(() => {
  'use strict';
  const RF=window.RF;
...
/* Realmforge V12.7.0 production finalizer. */
(() => {
  'use strict';
  const RF=window.RF;
  RF.VERSION='12.7.0';
  RF.BUILD={version:'12.7.0',title:'Fallen Memorials',built:'23 Sep 2026 • V12',buildId:'20260923-v1270-fallen-memorials'};
  RF.PRODUCTION_FOUNDATION=RF.PRODUCTION_FOUNDATION||{};
  Object.assign(RF.PRODUCTION_FOUNDATION,{
    phase:30,architecture:'canonical-systems-v12',legacyBaseline:'11.5.3',compatibilityLayer:'js/legacy/compat_gameplay_scoped_residuals_trimmed_v1153.js',saveSchema:RF.Core.contract.saveSchema,
