...
/* Realmforge V12.1.0 — canonical system/UI ownership verification. */
(() => {
  'use strict';
  const RF=window.RF;
...
/* Realmforge V12.1.0 production finalizer. */
(() => {
  'use strict';
  const RF=window.RF;
  RF.VERSION='12.1.0';
  RF.BUILD={version:'12.1.0',title:'Forge & Fletch',built:'22 Sep 2026 • V12',buildId:'20260922-v1210-forge-fletch'};
  RF.PRODUCTION_FOUNDATION=RF.PRODUCTION_FOUNDATION||{};
  Object.assign(RF.PRODUCTION_FOUNDATION,{
    phase:25,architecture:'canonical-systems-v12',legacyBaseline:'11.5.3',compatibilityLayer:'js/legacy/compat_gameplay_scoped_residuals_trimmed_v1153.js',saveSchema:RF.Core.contract.saveSchema,
