/* Realmforge V11.9.0 — generated canonical save-core bootstrap bundle. Do not hand-edit. */


/* ===== SOURCE: js/core/bootstrap.js ===== */
/* Realmforge V11.9.0 — canonical production bootstrap. */
window.RF = window.RF || {};
(() => {
  'use strict';
  const RF = window.RF;
