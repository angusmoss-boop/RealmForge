/* Realmforge V11.16.0 — Canonical Finalisation Bundle */
...
/* ===== js/core/system_ownership_v11_16.js ===== */
/* Realmforge V11.16.0 — canonical system ownership verification. */
(() => {
  'use strict';
  const RF=window.RF;
  ...
  const exploration=RF.Systems?.Exploration,locks=RF.Systems?.Locks,crime=RF.Systems?.Crime,property=RF.Systems?.Property;
  const expected={
    ...
    crime:["js/v10_4.js", "js/v10_5.js", "js/v10_6.js", "js/v10_8.js", "js/v10_30.js", "js/v10_31.js"],crimeFragments:["v3-crime-base", "v4-bounty-resolution", "v9_2-crime-foundation", "v10-pickpocket-tuning"],
