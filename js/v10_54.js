...
RF.BUILD={
  version:'10.54.0',
  title:'Local Markets',
  built:'17 Sep 2026 • 08:05 BST',
  buildId:'20260917-0805-bst'
};
RF.V1054=RF.V1054||{};

/* Realmforge V10.54 — Local Markets
   - Retires Shop as a global navigation page and moves commerce into suitable World locations.
   - Adds ten location-specific markets with finite daily stock, local pricing and tier-appropriate wares.
   - Rebuilds trading as a Vault-style Buy / Sell modal with 4-column item tiles and 2x4 category filters.
   - Adds a small range of new regional foods, weapons and armour to make each market feel distinct.
*/
...
if(RF.V95){RF.V95.SCHEMA='10.54.0';const om=RF.V95.migrate.bind(RF.V95);RF.V95.migrate=s=>V.migrate(om(s))}
