(() => {
  ...
  ok(RF.VERSION==='12.5.0','version');
  ok(RF.Core?.contract?.appVersion==='12.5.0','core app version');
  ok(RF.Core?.contract?.saveSchema==='12.5.0','save schema');
  ...
  window.RF_TEST_V1250={pass:fail.length===0,fail};
})();
