const CACHE='realmforge-v12-4-0';
const FILES=[
  './','./index.html','./style.css','./manifest.webmanifest',
  './js/data/base_content.js','./js/legacy/base/state.js','./js/legacy/base/ui.js',
  './js/dist/save_core_v12_4.js','./js/dist/data_core_v12_4.js',
  './js/legacy/base/main.js','./js/dist/systems_core_v12_4.js','./js/legacy/compat_gameplay_scoped_residuals_trimmed_v1153.js',
  './js/dist/canonical_v12_4.js','./version.txt'
];
