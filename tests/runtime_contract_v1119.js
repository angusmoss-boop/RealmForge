(() => {
  ...
  ok(RF.VERSION==='11.19.0','version');
  ok(RF.Core?.contract?.appVersion==='11.19.0','core app version');
  ...
  ['copyText','fetchBuildInfo','registerServiceWorker','onBackNavigation','pushHistoryState','replaceHistoryState'].forEach(k=>ok(typeof p?.[k]==='function','platform bridge '+k));
  ...
  window.RF_TEST_V1119={pass:fail.length===0,fail};
})();
