...
checks.version=R.VERSION==='12.5.0';checks.schema=R.V95?.SCHEMA==='12.5.0';checks.authoring=R.Authoring?.report?.().valid===true;
...
checks.noStateSchemaChange=R.Core.contract.saveSchema==='12.5.0';checks.ownership=R.PRODUCTION_FOUNDATION?.systemOwnership?.valid===true;
