...
checks.exportPackage=pkg.format==='realmforge-save-backup'&&pkg.formatVersion===1&&pkg.checksum===C.hash(pkg.payload)&&pkg.saveSchema==='12.6.0';
...
checks.schemaUnchanged=C.SCHEMA==='12.6.0'&&R.Core.contract.saveSchema==='12.6.0';
