(() => {
  ...
  ok(RF.VERSION==='12.2.1','version');
  ok(RF.Core?.contract?.appVersion==='12.2.1','core app version');
  ...
  ok(RF.Views?.Database?.modernVersion==='12.2.1'&&RF.PRODUCTION_FOUNDATION?.systemOwnership?.databaseModern===true,'V12.2 Living Codex final presentation owner');
  ...
  window.RF_TEST_V1221={pass:fail.length===0,fail};
})();
