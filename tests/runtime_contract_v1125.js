(() => {
  ...
  ok(RF.VERSION==='11.25.0','version');
  ok(RF.Core?.contract?.appVersion==='11.25.0','core app version');
  ...
  ok(RF.Systems?.Character?.installedFragments?.length===7,'character fragment count');
  ...
  ok(['v3-combat-techniques','v3-combat-win-perks','v3-combat-ui','v8_2-combat-feedback','v8_3-cadence-motion','v9_1-parry-focus','v9_2-defeat-xp','v10-battle-summary','v7-research-combat','v9-combat-focus-core','v9-combat-focus-ui'].every(x=>RF.Systems?.Combat?.installedFragments?.includes(x)),'combat ancestry fragments');
  ...
  window.RF_TEST_V1124={pass:fail.length===0,fail};
})();
