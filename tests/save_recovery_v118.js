...
for(const rel of ['js/legacy/base/data.js','js/legacy/base/state.js','js/legacy/base/ui.js','js/dist/save_core_v11_8.js','js/legacy/base/main.js','js/legacy/compat_gameplay_v1153.js','js/dist/canonical_v11_8.js']){try{vm.runInContext(fs.readFileSync(path.join(root,rel),'utf8'),ctx,{filename:rel})}catch(_){}}
