...
const scripts=['js/data/base_content.js','js/legacy/base/state.js','js/legacy/base/ui.js','js/dist/save_core_v12_4.js','js/dist/data_core_v12_4.js','js/legacy/base/main.js','js/dist/systems_core_v12_4.js','js/legacy/compat_gameplay_scoped_residuals_trimmed_v1153.js','js/dist/canonical_v12_4.js'];
...
checks.version=R.VERSION==='12.4.0'&&R.Core?.contract?.appVersion==='12.4.0';
checks.schema=R.Core?.contract?.saveSchema==='11.5.3'&&R.V95?.SCHEMA==='11.5.3';
