/* Realmforge V11.9.0 — Canonical base content.
   This is the former foundation data table, now owned by js/data. */
window.RF = window.RF || {};
RF.DATA = {
  backgrounds: {
  ...
  shopStock:['bread','torch','lockpick','arrow','rusty_sword','shortbow','leather_vest','potion'],
  quests: {
