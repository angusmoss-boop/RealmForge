...
checks.version=R.VERSION==='12.2.1';checks.schema=R.V95?.SCHEMA==='11.5.3';checks.authoring=R.Authoring?.report?.().valid===true;
...
checks.noStateSchemaChange=R.Core.contract.saveSchema==='11.5.3';checks.ownership=R.PRODUCTION_FOUNDATION?.systemOwnership?.valid===true;
