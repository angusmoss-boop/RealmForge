...
const oldScripts=['js/data/base_content.js','js/legacy/base/state.js','js/legacy/base/ui.js','js/dist/save_core_v11_21.js','js/dist/data_core_v11_21.js','js/legacy/base/main.js','js/dist/systems_core_v11_21.js','js/legacy/compat_gameplay_world_social_trimmed_v1153.js','js/dist/canonical_v11_21.js'];
const newScripts=['js/data/base_content.js','js/legacy/base/state.js','js/legacy/base/ui.js','js/dist/save_core_v11_22.js','js/dist/data_core_v11_22.js','js/legacy/base/main.js','js/dist/systems_core_v11_22.js','js/legacy/compat_gameplay_encounter_interface_trimmed_v1153.js','js/dist/canonical_v11_22.js'];
...
const stripBuild=h=>norm(h).replace(/V11\.(?:20|21|22)\.0 • Canonical [^<]+/g,'Vx • Canonical').replace(/Built 19 Sep 2026 • (?:18:50|19:16|20:05) BST/g,'Built x');
...
const stripMenu=h=>norm(h).replace(/V11\.(?:20|21|22)\.0 • Canonical [^<]+/g,'Vx • Canonical').replace(/Built 19 Sep 2026 • (?:18:50|19:16|20:05) BST/g,'Built x');
...
checks.compatReduced=require('fs').readFileSync(require('path').join(root,'js/legacy/compat_gameplay_encounter_interface_trimmed_v1153.js')).length<284029;
...
checks.itemBrowserCanonical=B.Modules?.info?.('ui.itemBrowser')?.meta?.status==='canonical'&&B.Views?.ItemBrowser?.installedFragments?.length===4;
...
checks.ownership=B.PRODUCTION_FOUNDATION?.systemOwnership?.valid===true;checks.schema=B.V95?.SCHEMA==='11.5.3';checks.version=B.VERSION==='11.22.0';
