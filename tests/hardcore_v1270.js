...
checks.owner=R.Modules.info('systems.hardcore')?.meta?.status==='canonical'&&R.CampaignMode?.version==='12.7.0'&&R.PRODUCTION_FOUNDATION?.systemOwnership?.hardcoreCanonical===true;
...
checks.reloadFrontDoor=R2.V101.mainMenu===true&&f2.app.innerHTML.includes('Enter the Realm');R2.V101.mainMenu=false;R2.Core.Campaigns.loadSlot(id);R2.UI.render(R2.state);checks.reloadMemorial=f2.app.innerHTML.includes('Game Over')&&f2.app.innerHTML.includes('permanently concluded');
